...
// Don't define functions / constructors inside of conditions.  Try defining at the top of the file.
...
// We were attaching the event listener twice, causing a double count of current Round.
...
function roundCount(totalRounds, currentRound) {
  console.log('HERE IS THE TOTAL AND CURRENT VOTING ROUND', totalRounds, currentRound);
